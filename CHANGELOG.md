...
* Added ability to exclude an item from being activated by specifying `activatable` flag `i-active-items` trait
* Added `getItemByValue` method `i-active-items` trait, `b-list`
