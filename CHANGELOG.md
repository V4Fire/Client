...
which was causing the :suspend flag and mute/unmute functions not to work correctly during deactivation/activation of components.](https://github.com/V4Fire/Client/pull/1199) `src/core/component/event/component`
