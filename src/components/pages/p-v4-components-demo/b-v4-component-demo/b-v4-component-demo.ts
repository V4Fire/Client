...
/**
 * [[include:components/pages/p-v4-components-demo/b-v4-component-demo/README.md]]
 * @packageDocumentation
 */

import iBlock, { component, system, wait, prop } from 'components/super/i-block/i-block';
...
export default class bV4ComponentDemo extends iBlock {
	...
	protected setDebugMod(el: Element, mod: string, value: string): CanPromise<void> {
		...
		for (let o = Array.from(parent.children), i = 0; i < o.length; i++) {
			const c = o[i];
			this.block?.setElementMod(c, 'modValue', 'selected', c === el);
		}
	}
