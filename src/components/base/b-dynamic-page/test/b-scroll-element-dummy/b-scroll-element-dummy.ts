...
import bDummy, { component, watch } from 'components/dummies/b-dummy/b-dummy';
import type { OnBeforeSwitchPage } from 'components/base/b-dynamic-page/b-dynamic-page';
