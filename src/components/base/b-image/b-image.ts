...
/**
 * [[include:components/base/b-image/README.md]]
...
import iBlock, { component, prop, hook, wait, ModsDecl } from 'components/super/i-block/i-block';
import type { SizeType } from 'components/base/b-image/interface';

export * from 'components/super/i-block/i-block';
export * from 'components/base/b-image/interface';
