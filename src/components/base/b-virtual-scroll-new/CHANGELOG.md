...
* Now `bVirtualScrollNew` will throw an error if the rendering of components returns an empty array

## v3.0.0-rc.153 (2021-03-04)

#### :house: Internal

* [`bVirtualScrollNew` is now implements `iItems` trait](https://github.com/V4Fire/Client/issues/471)
