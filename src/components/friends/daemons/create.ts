...
import { wait } from 'components/super/i-block/decorators';

import type Daemons from 'components/friends/daemons/class';
import { mergeDaemons } from 'components/friends/daemons/helpers';

import type { Daemon, WrappedDaemon, DaemonsDict } from 'components/friends/daemons/interface';
