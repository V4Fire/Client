...
/**
 * [[include:components/super/i-static-page/modules/provider-data-store/README.md]]
 * @packageDocumentation
 */

import type { AbstractCache } from 'core/cache';

import ProviderDataItem from 'components/super/i-static-page/modules/provider-data-store/item';
import type { ProviderDataStore } from 'components/super/i-static-page/modules/provider-data-store/interface';

export * from 'components/super/i-static-page/modules/provider-data-store/interface';
