...
import { fitForText, convertCursorPositionToRaw } from 'components/super/i-input-text/modules/mask/helpers';
import type { SyncMaskWithTextOptions } from 'components/super/i-input-text/modules/mask/interface';
