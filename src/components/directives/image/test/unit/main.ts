...
test.describe('components/directives/image', () => {
	...
	test('the srcset attribute of img should be set if .srcset is provided', async ({page}) => {
		const srcset = {
	...
	test('a preview should be shown if image is not loaded yet', async ({page, context}) => {
