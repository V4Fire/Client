...
} from 'base/b-virtual-scroll-2/interface';

import { defaultShouldProps, componentItemType, itemsProcessors } from 'base/b-virtual-scroll-2/const';

import type { Observer } from 'base/b-virtual-scroll-2/modules/observer';
...
export default abstract class iVirtualScrollProps extends iData {
	 ...
	 * @example
	 * ```
	 * < b-virtual-scroll-2 :tombstoneCount = 3
	 *   < template #tombstone
	 *     < .&__skeleton
	 *       Skeleton
	 * ```
	...
	@prop({
		type: Function,
		default: (state: VirtualScrollState, ctx: bVirtualScroll2) => {
	 ...
	 * in `b-virtual-scroll-2` throughout the app.
	 *
	 ...
	 * ```
	 *
	 * To set this function as the global component processor in `b-virtual-scroll-2`,
	 * override the `itemsProcessors` constant (in `base/b-virtual-scroll-2/const.ts`) of your layer and export it.
	 *
	 * @example
	 * ```typescript
	 ...
	 * ```
	 *
	 * After redefining this, `b-virtual-scroll-2` renders `b-ads-component` after
	 * each `item` component.
	 *
