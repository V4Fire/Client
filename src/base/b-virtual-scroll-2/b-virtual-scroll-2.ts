...
/**
 * [[include:base/b-virtual-scroll-2/README.md]]
...
import { iVirtualScrollHandlers } from 'base/b-virtual-scroll-2/handlers';
import { bVirtualScrollAsyncGroup, bVirtualScrollDomInsertAsyncGroup, componentModes, renderGuardRejectionReason } from 'base/b-virtual-scroll-2/const';
import type { VirtualScrollState, RenderGuardResult, $ComponentRefs, UnsafeBVirtualScroll, ItemsProcessors, ComponentMode } from 'base/b-virtual-scroll-2/interface';

import { ComponentTypedEmitter, componentTypedEmitter } from 'base/b-virtual-scroll-2/modules/emitter';
import { ComponentInternalState } from 'base/b-virtual-scroll-2/modules/state';
import { SlotsStateController } from 'base/b-virtual-scroll-2/modules/slots';
import { ComponentFactory } from 'base/b-virtual-scroll-2/modules/factory';
import { Observer } from 'base/b-virtual-scroll-2/modules/observer';

import iData, { component, system, watch, wait, RequestParams, UnsafeGetter } from 'super/i-data/i-data';

export * from 'base/b-virtual-scroll-2/interface';
export * from 'base/b-virtual-scroll-2/const';
...
@component()
export default class bVirtualScroll2 extends iVirtualScrollHandlers implements iItems {

	/** {@link componentTypedEmitter} */
	@system<bVirtualScroll2>((ctx) => componentTypedEmitter(ctx))
	protected readonly componentEmitter!: ComponentTypedEmitter;

	/** {@link SlotsStateController} */
	@system<bVirtualScroll2>((ctx) => new SlotsStateController(ctx))
	protected readonly slotsStateController!: SlotsStateController;

	/** {@link ComponentInternalState} */
	@system<bVirtualScroll2>((ctx) => new ComponentInternalState(ctx))
	protected readonly componentInternalState!: ComponentInternalState;

	/** {@link ComponentFactory} */
	@system<bVirtualScroll2>((ctx) => new ComponentFactory(ctx))
	protected readonly componentFactory!: ComponentFactory;

	/** {@link Observer} */
	@system<bVirtualScroll2>((ctx) => new Observer(ctx))
	...
	/**
	 * Short-hand wrapper for calling {@link bVirtualScroll2.shouldStopRequestingData}, which also caches the
	 * result of the call and, if {@link bVirtualScroll2.shouldStopRequestingData} returns `true`, does not call
	...
	/**
	 * Short-hand wrapper for calling {@link bVirtualScroll2.shouldPerformDataRequest}, removing the need to pass
	 * state and context when calling {@link bVirtualScroll2.shouldPerformDataRequest}.
	 */
	 ...
	 * on the result of the {@link bVirtualScroll2.renderGuard} method.
	 *
	...
	/**
	 * Renders components using {@link bVirtualScroll2.componentFactory} and inserts them into the DOM tree
	 */
