...
import type { ComponentItemType, VirtualScrollState, ItemsProcessors } from 'base/b-virtual-scroll-2/interface';

/**
 * Base group for performing asynchronous operations of the component.
 */
export const bVirtualScrollAsyncGroup = 'b-virtual-scroll-2';
...
export const defaultShouldProps = <const>{
	...
	shouldStopRequestingData: (state: VirtualScrollState, _ctx: bVirtualScroll2): boolean => {
	...
	shouldPerformDataRequest: (state: VirtualScrollState, _ctx: bVirtualScroll2): boolean => {
	...
	shouldPerformDataRender: (state: VirtualScrollState, _ctx: bVirtualScroll2): boolean =>
