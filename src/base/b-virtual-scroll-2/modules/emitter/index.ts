...
import type { ComponentEvents, LocalEventPayload } from 'base/b-virtual-scroll-2/interface';
import type { ComponentTypedEmitter } from 'base/b-virtual-scroll-2/modules/emitter/interface';

export * from 'base/b-virtual-scroll-2/modules/emitter/interface';

/**
 * Provides methods for interacting with the `selfEmitter` using typed events
 * @param ctx
 */
export function componentTypedEmitter(ctx: bVirtualScroll2): ComponentTypedEmitter {
