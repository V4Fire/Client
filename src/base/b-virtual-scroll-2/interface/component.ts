...
import type { componentModes } from 'base/b-virtual-scroll-2/b-virtual-scroll-2';
...
export interface ComponentItemMeta extends Dictionary {
	 ...
	 *
	 * If `iItems` props are used to create representations, `b-virtual-scroll-2` will automatically add
...
export interface ComponentItemFactory<DATA = unknown> {
	(state: VirtualScrollState<DATA>, ctx: bVirtualScroll2): ComponentItem[];
}
...
export interface ItemsProcessor {
	(componentItems: ComponentItem[], ctx: bVirtualScroll2): ComponentItem[];
}
