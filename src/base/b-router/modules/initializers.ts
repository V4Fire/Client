...
export function initRoutes(component: bRouter): RouteBlueprints {
	return component.sync.link(compileRoutes.bind(null, component));
}

/**
 * Compiles the specified routes and returns the compiled object
 *
 * @param component
 * @param [routes]
 */
export function compileRoutes(
	component: bRouter,
	routes: StaticRoutes = component.engine.routes || globalRoutes
): RouteBlueprints {
	const
