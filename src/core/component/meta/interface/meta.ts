...
export interface ComponentMeta {
	...
	/**
	 * A sorted array of fields and functions for their initialization on the component
	 */
	fieldInitializers: ComponentFieldInitializers;
	 ...
	 */
	systemFieldInitializers: ComponentFieldInitializers;
