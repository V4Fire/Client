...
import watch, { mute, unmute, unwrap, getProxyType, isProxy, WatchHandlerParams } from '@src/core/object/watch';

import { getPropertyInfo, PropertyInfo } from '@src/core/component/reflection';
import type { ComponentInterface, WatchOptions, RawWatchHandler } from '@src/core/component/interface';

import { tiedWatchers, watcherInitializer, fakeCopyLabel } from '@src/core/component/watch/const';
import { cloneWatchValue } from '@src/core/component/watch/clone';
