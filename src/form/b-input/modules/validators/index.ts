...
import type bInput from '@src/form/b-input/b-input';
...
} from '@src/form/b-input/modules/validators/interface';

export * from '@src/form/b-input/modules/validators/interface';
