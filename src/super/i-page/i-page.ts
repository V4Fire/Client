...
import iData, { component, prop, system, computed, watch, hook, ModsDecl } from '@src/super/i-data/i-data';
import type { TitleValue, StageTitles, ScrollOptions } from '@src/super/i-page/interface';

export * from '@src/super/i-data/i-data';
export * from '@src/super/i-page/interface';
