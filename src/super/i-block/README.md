...
* `super/i-block/base` - the module provides a common API to work with components.
* `super/i-block/event` - the module provides an event emitter API to work with components.
* `super/i-block/mods` - the module provides an API to work with a component in terms of [BEM](https://en.bem.info/methodology/quick-start/).
* `super/i-block/state` - the module provides an API for convenient work with component states.
* `super/i-block/providers` - the module provides an API for initializing and loading external data to a component.
* `super/i-block/decorators` - the module re-exports the base decorators from `core/component/decorators` and also provides additional decorators.
