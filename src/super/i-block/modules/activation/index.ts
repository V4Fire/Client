...
import { runHook, callMethodFromComponent } from '@src/core/component';
...
} from '@src/super/i-block/modules/activation/const';

export * from '@src/super/i-block/modules/activation/const';
