...
import { wait } from '@src/super/i-block/modules/decorators';
...
} from '@src/super/i-block/modules/daemons/interface';

export * from '@src/super/i-block/modules/daemons/interface';
