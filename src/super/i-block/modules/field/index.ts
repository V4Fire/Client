...
import { unwrap } from '@src/core/object/watch';
import { getPropertyInfo } from '@src/core/component';

import iBlock from '@src/super/i-block/i-block';
import Friend from '@src/super/i-block/modules/friend';

import type { KeyGetter, ValueGetter } from '@src/super/i-block/modules/field/interface';

export * from '@src/super/i-block/modules/field/interface';
