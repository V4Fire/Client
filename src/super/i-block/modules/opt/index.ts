...
import { literalCache } from '@src/super/i-block/modules/opt/const';
import type { IfOnceValue } from '@src/super/i-block/modules/opt/interface';

export * from '@src/super/i-block/modules/opt/const';
export * from '@src/super/i-block/modules/opt/interface';
