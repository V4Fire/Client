...
import type { Hook } from '@src/core/component';
import type { Cb } from '@src/super/i-block/modules/lfc/interface';

export * from '@src/super/i-block/modules/lfc/interface';
