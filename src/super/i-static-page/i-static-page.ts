...
import { RestrictedCache } from '@src/core/cache';
import { setLocale, locale } from '@src/core/i18n';
import { reset, ResetType, ComponentInterface } from '@src/core/component';

import type bRouter from '@src/base/b-router/b-router';
import type { AppliedRoute } from '@src/core/router';

import type iBlock from '@src/super/i-block/i-block';
import iPage, { component, field, system, computed, watch } from '@src/super/i-page/i-page';

import createProviderDataStore, { ProviderDataStore } from '@src/super/i-static-page/modules/provider-data-store';
import themeManagerFactory, { ThemeManager } from '@src/super/i-static-page/modules/theme';

import type { RootMod } from '@src/super/i-static-page/interface';

export * from '@src/super/i-page/i-page';
export * from '@src/super/i-static-page/modules/theme';

export { createProviderDataStore };
export * from '@src/super/i-static-page/modules/provider-data-store';

export * from '@src/super/i-static-page/interface';
